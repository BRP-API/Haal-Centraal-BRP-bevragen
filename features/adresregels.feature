...
Functionaliteit: adresregels worden gevuld met het binnenlandse of buitenlandse adres
  Als de verblijfplaats een binnenlands BAG-adres is (Identificatiecode nummeraanduiding 11.90 heeft een waarde),
  Dan wordt verblijfplaats.adresregel1 gevuld met naamOpenbareRuimte (11.15) + huisnummer (11.20)+ huisletter (11.30) + huisnummertoevoeging (11.40)
  ...
  Scenario: verblijfplaats is een binnenlands BAG-adres
    Gegeven persoon met burgerservicenummer "999993653" heeft de volgende gegevens bij verblijfplaats:
    """
      "huisnummer": 31,
      "woonplaats": "Rotterdam",
      "naamOpenbareRuimte": "Boterdiep",
      "postcode": "3077AW",
      "straat": "Boterdiep"
    """
    Als persoon met burgerservicenummer "999993653" wordt opgevraagd met fields=verblijfplaats.adresregel1,verblijfplaats.adresregel2,verblijfplaats.adresregel3,verblijfplaats.land
    Dan bevat het antwoord:
    """
    "verblijfplaats": {
      "adresregel1": "Boterdiep 31",
      "adresregel2": "3077AW Rotterdam"
    }
    """
  ...
  Scenario: verblijfplaats is een binnenlands BAG-adres met huisletter en huisnummertoevoeging
    ...
    """
    Als persoon met burgerservicenummer "999990160" wordt opgevraagd met fields=verblijfplaats.adresregel1,verblijfplaats.adresregel2,verblijfplaats.adresregel3,verblijfplaats.land
    Dan bevat het antwoord:
    """
    "verblijfplaats": {
  ...
  Scenario: verblijfplaats is een binnenlands niet-BAG adres
    ...
    """
    Als persoon met burgerservicenummer "999991802" wordt opgevraagd met fields=verblijfplaats.adresregel1,verblijfplaats.adresregel2,verblijfplaats.adresregel3,verblijfplaats.land
    Dan bevat het antwoord:
    """
    "verblijfplaats": {
  ...
  Scenario: verblijfplaats is een binnenlands niet-BAG adres met aanduidingBijHuisnummer
    ...
    """
      ...
      "gemeenteVanInschrijving": "1681"
    """
    Als persoon met burgerservicenummer "999990482" wordt opgevraagd met fields=verblijfplaats.adresregel1,verblijfplaats.adresregel2,verblijfplaats.adresregel3,verblijfplaats.land
    Dan bevat het antwoord:
    """
    "verblijfplaats": {
  ...
  Scenario: verblijfplaats is een locatiebeschrijving
    ...
    """
    Als persoon met burgerservicenummer "000009921" wordt opgevraagd met fields=verblijfplaats.adresregel1,verblijfplaats.adresregel2,verblijfplaats.adresregel3,verblijfplaats.land
    Dan bevat het antwoord:
    """
    "verblijfplaats": {
