...
Functionaliteit: personen kunnen worden gezocht met bepaalde combinaties van parameters
  ...
  Abstract Scenario: Er kan gezocht worden op minimale combinaties van zoekparamters + optioneel andere zoekparameters
    ...
    Voorbeelden: minimale combinaties van zoekparameters
      | Situatie | geslachtsnaam | voornamen | geboortedatum | geslachtsaanduiding | gemeentevaninschrijving | naamopenbareruimte | huisnummer | huisletter | huisnummertoevoeging | postcode | identificatiecodenummeraanduiding | burgerservicenummer | resultaat | voorbeeld |
      ...
      | alle naam en geboorte parameters                          | Ja  | Ja  | Ja  | Ja  | Ja  |  -  |  -  |  -  |  -  |  -  |  -  |  -  | zoekresultaten  | ?naam__geslachtsnaam=groen&naam__voornamen=frank&geboorte__datum=1983-05-26&geboorte__plaats=Sas%20van%20Gent&geslachtsaanduiding=M&verblijfplaats__gemeentevaninschrijving=0014 |
      ...
      | alle optionele + gedeeltelijk min. combinaties            | Ja  | Ja  |  -  | Ja  | Ja  | Ja  |  -  | Ja  | Ja  | Ja  |  -  |  -  | een foutmelding | ?naam__geslachtsnaam=groenlo&naam__voornamen=franka&geboorte__plaats=delft&geslachtsaanduiding=V&verblijfplaats__gemeentevaninschrijving=0503&verblijfplaats__naamopenbareruimte=Sint%20Aldegondestraat&verblijfplaats__huisletter=A&verblijfplaats__huisnummertoevoeging=to&verblijfplaats__postcode=2628HJ |
      | postcode+huisnummer                                       |  -  |  -  |  -  |  -  |  -  |  -  | Ja  |  -  |  -  | Ja  |  -  |  -  | zoekresultaten  | ?verblijfplaats__huisnummer=2&verblijfplaats__postcode=2628HJ |
      | postcode+huisnummer + optionele parameters                |  -  | Ja  | Ja  | Ja  | Ja  |  -  | Ja  | Ja  | Ja  | Ja  |  -  |  -  | zoekresultaten  | ?naam__voornamen=franka&geboorte__datum=1983-05-26&geboorte__plaats=delft&geslachtsaanduiding=V&verblijfplaats__gemeentevaninschrijving=0503&verblijfplaats__huisnummer=2&verblijfplaats__huisletter=A&verblijfplaats__huisnummertoevoeging=to&verblijfplaats__postcode=2628HJ |
