...
Functionaliteit: personen kunnen worden gezocht met bepaalde combinaties van parameters
  ...
  Abstract Scenario: Er kan gezocht worden op minimale combinaties van zoekparamters + optioneel andere zoekparameters
    ...
    Voorbeelden: minimale combinaties van zoekparameters
      | Situatie | geslachtsnaam | voornamen | geboortedatum | geboorteplaats | geslachtsaanduiding | gemeentevaninschrijving | naamopenbareruimte | huisnummer | huisletter | huisnummertoevoeging | postcode | identificatiecodenummeraanduiding | resultaat | voorbeeld |
      | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
      | geslachtsnaam+geboortedatum                     | Ja  |  -  | Ja  |  -  |  -  |  -  |  -  |  -  |  -  |  -  |  -  |  -  | zoekresultaten  | ?naam__geslachtsnaam=groen&geboorte__geboortedatum=1983-05-26 |
      | geslachtsnaam+geboortedatum+optionele parameter | Ja  | Ja  | Ja  |  -  |  -  |  -  |  -  |  -  |  -  |  -  |  -  |  -  | zoekresultaten  | ?naam__geslachtsnaam=groen&naam__voornamen=frank&geboorte__geboortedatum=1983-05-26 |
      ...
      | geslachtsnaam+geboortedatum + gedeelte andere combinatie | Ja  |  -  | Ja  |  -  |  -  |  -  |  -  |  -  |  -  |  -  | Ja  |  -  | zoekresultaten  | ?naam__geslachtsnaam=groen&geboorte__geboortedatum=1983-05-26&verblijfplaats__postcode=9744CZ |
      | meerdere minimale combinaties in één aanroep    | Ja  |  -  | Ja  |  -  |  -  |  -  |  -  |  -  |  -  |  -  |  -  | Ja  | zoekresultaten  | ?naam__geslachtsnaam=groen&geboorte__geboortedatum=1983-05-26&identificatiecodenummeraanduiding=0704019876543210 |
      ...
      | alle optionele + gedeeltelijk min. combinaties  | Ja  | Ja  |  -  | Ja  | Ja  | Ja  | Ja  |  -  | Ja  | Ja  | Ja  |  -  | een foutmelding | ?naam__geslachtsnaam=groenlo&naam__voornamen=franka&geboorte__plaats=delft&geslachtsaanduiding=V&gemeentevaninschrijving=0503&verblijfplaats__naamopenbareruimte=Sint%20Aldegondestraat&verblijfplaats__huisletter=A&verblijfplaats__huisnummertoevoeging=to&verblijfplaats__postcode=2628HJ |
      | postcode+huisnummer                             |  -  |  -  |  -  |  -  |  -  |  -  |  -  | Ja  |  -  |  -  | Ja  |  -  | zoekresultaten  | ?verblijfplaats__huisnummer=2&verblijfplaats__postcode=2628HJ |
      | postcode+huisnummer + optionele parameters      |  -  | Ja  | Ja  | Ja  | Ja  | Ja  |  -  | Ja  | Ja  | Ja  | Ja  |  -  | zoekresultaten  | ?naam__voornamen=franka&geboorte__datum=1983-05-26&geboorte__plaats=delft&geslachtsaanduiding=V&gemeentevaninschrijving=0503&verblijfplaats__huisnummer=2&verblijfplaats__huisletter=A&verblijfplaats__huisnummertoevoeging=to&verblijfplaats__postcode=2628HJ |
      | overlappende zoekparameters op verblijfplaats   |  -  |  -  |  -  |  -  |  -  | Ja  | Ja  | Ja  |  -  |  -  | Ja  | Ja  | zoekresultaten  | ?gemeentevaninschrijving=0503&verblijfplaats__naamopenbareruimte=Sint%20Aldegondestraat&verblijfplaats__huisnummer=2&verblijfplaats__postcode=2628HJ&identificatiecodenummeraanduiding=893675839595730 |
      | strijdige zoekparameters op verblijfplaats    |  -  |  -  |  -  |  -  |  -  | Ja  | Ja  | Ja  |  -  |  -  | Ja  | Ja  | zoekresultaten  | ?gemeentevaninschrijving=0503&verblijfplaats__naamopenbareruimte=Beethovenlaan&verblijfplaats__huisnummer=2&verblijfplaats__postcode=2628HJ&identificatiecodenummeraanduiding=704019876543210 |
      | gemeentevaninschrijving + openbareruimtenaam + huisnummer |  -  |  -  |  -  |  -  |  -  | Ja  | Ja  | Ja  |  -  |  -  |  -  |  -  | zoekresultaten  | ?gemeentevaninschrijving=0503&verblijfplaats__naamopenbareruimte=Sint%20Aldegondestraat&verblijfplaats__huisnummer=2 |
      | verblijfplaats zonder huisnummer                          |  -  |  -  |  -  |  -  |  -  | Ja  | Ja  |  -  |  -  |  -  |  -  |  -  | een foutmelding  | ?gemeentevaninschrijving=0503&verblijfplaats__naamopenbareruimte=Sint%20Aldegondestraat |
      | verblijfplaats zonder openbareruimtenaam                  |  -  |  -  |  -  |  -  |  -  | Ja  |  -  | Ja  |  -  |  -  |  -  |  -  | een foutmelding  | ?gemeentevaninschrijving=0503&verblijfplaats__huisnummer=2  |
      ...
      | identificatiecodenummeraanduiding                         |  -  |  -  |  -  |  -  |  -  |  -  |  -  |  -  |  -  |  -  |  -  | Ja  | een foutmelding  | ?identificatiecodenummeraanduiding=0704019876543210 |
