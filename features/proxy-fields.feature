...
Functionaliteit: vertalen van gevraagde samengestelde of afgeleide velden naar vragen van bron velden
  ...
  Rule: wanneer een gegeven van verblijfplaats wordt gevraagd, moeten ook straat, huisnummer, locatiebeschrijving en verblijfplaats.land worden gevraagd
    ...
    Abstract Scenario: vragen om <gevraagd aan proxy> moet ook minimale verblijfplaatsgegevens vragen
      ...
      | adresregel1                            | adresregel1,straat,locatiebeschrijving,huisnummer,huisletter,huistoevoeging,aanduidingBijHuisnummer,verblijfplaats.land                                                         |
      ...
      | adresregel1,adresregel2                | adresregel1,straat,locatiebeschrijving,huisnummer,huisletter,huistoevoeging,aanduidingBijHuisnummer,adresregel2,postcode,woonplaats,gemeenteVanInschrijving,verblijfplaats.land |
    ...
    Abstract Scenario: zoeken van personen en vragen om <gevraagd aan proxy> moet ook minimale verblijfplaatsgegevens vragen
      ...
      Voorbeelden:
      | gevraagd aan proxy                   | vragen aan RvIG                                                                                                              |
      | volledigeNaam,adresregel1,woonplaats | naam,adresregel1,straat,locatiebeschrijving,huisnummer,huisletter,huistoevoeging,aanduidingBijHuisnummer,verblijfplaats.land |
