...
Functionaliteit: in onderzoek
  Wanneer de juistheid van een gegeven onderzocht wordt, en daardoor de waarde van een geleverd gegeven mogelijk onjuist is, wordt, ook als er niet om inOnderzoek gegevens van dat gegeven wordt gevraagd, 
  naast het betreffende veld in inOnderzoek een veld met dezelfde naam opgenomen. Deze krijgt dan de boolean waarde true.

  Alle gegevens van een categorie kunnen in onderzoek zijn, maar ook alle gegevens van individuele groepen of afzonderlijke gegevens binnen de categorie.
  Er kunnen tegelijkertijd gegevens van meerdere categorieën in onderzoek zijn.

  Een gegeven dat niet in onderzoek is, wordt niet in inOnderzoek opgenomen, ook niet met de waarde false of null.
  ...
  Rule: wanneer een categorie in de bron in onderzoek is, wordt voor elk uit die categorie afkomstig en gevraagd gegeven ook in inOnderzoek een gegeven opgenomen met de waarde true
    ...
    Scenario: vragen om meerdere velden van persoon bij hele categorie persoon in onderzoek
    ...
    Abstract Scenario: vragen om <gegeven> zonder waarde bij <in onderzoek> in onderzoek
      ...
      | Arnitta           | <aanduiding in onderzoek>       | 20120920                       |
      Als personen wordt gezocht met de volgende parameters
      | naam                | waarde                          |
      | type                | RaadpleegMetBurgerservicenummer |
    ...
    Scenario: persoon heeft zowel persoon als ouder 1 in onderzoek
      ...
      | 19231213              | 010000                          | 20120920                       |
      En de persoon heeft een ouder '1' met de volgende gegevens
      | burgerservicenummer | aanduiding in onderzoek (83.10) | datum ingang onderzoek (83.20) |
      | 000000115           | 020000                          | 20101205                       |
      Als personen wordt gezocht met de volgende parameters
      | naam                | waarde                                    |
      | type                | RaadpleegMetBurgerservicenummer           |
      | burgerservicenummer | 000000139                                 |
      | fields              | geboorte.datum,ouders.burgerservicenummer |
      Dan heeft de response een persoon met de volgende gegevens
      | naam                                                     | waarde            |
      ...
      | geboorte.inOnderzoek.datum                               | true              |
      | geboorte.inOnderzoek.datumIngangOnderzoek.type           | Datum             |
      | geboorte.inOnderzoek.datumIngangOnderzoek.datum          | 2012-09-20        |
      | geboorte.inOnderzoek.datumIngangOnderzoek.langFormaat    | 20 september 2012 |
      | ouders.burgerservicenummer                               | 000000115         |
      | ouders.inOnderzoek.burgerservicenummer                   | true              |
      | ouders.inOnderzoek.datumIngangOnderzoekGezag.type        | Datum             |
      | ouders.inOnderzoek.datumIngangOnderzoekGezag.datum       | 2010-12-05        |
      | ouders.inOnderzoek.datumIngangOnderzoekGezag.langFormaat | 5 december 2010   |

  Rule: wanneer een groep in de bron in onderzoek is, wordt elk gegeven in het antwoord dat gevuld wordt uit een van de elementen in die groep en dat volgens '/features/in onderzoek.xlsx' ook in onderzoek is 
    opgenomen in inOnderzoek met de waarde true
  ...
  Rule: wanneer een element in de bron in onderzoek is, wordt het gegeven in het antwoord dat daaruit gevuld wordt ook in inOnderzoek opgenomen met de waarde true
    ...
    Abstract Scenario: persoon heeft <in onderzoek> in onderzoek
      ...
      Voorbeelden:
      | aanduiding in onderzoek | in onderzoek        | veld                | waarde     | omschrijving |
      | 010120                  | burgerservicenummer | burgerservicenummer | 000000309  |              |
      | 010410                  | geslacht            | geslacht.code       | M          | Man          |
...
# Afhankelijk van de uitkomst van de discussie over het vereenvoudigen van fields bij verblijfplaats moet dit scenario mogelijk worden aangepast.
# 'Mogelijk' omdat het scenario in principe correct is aangezien het levert wat aanwezig is. De vraag is of het ook realistisch moet zijn.
...
# 'Mogelijk' omdat het scenario in principe correct is aangezien het levert wat aanwezig is. De vraag is of het ook realistisch moet zijn.
    ...
    Abstract Scenario: persoon heeft <veld> van ouder in onderzoek
      ...
      | 020210 | burgerservicenummer                     | 1     | 2            |
      | 030410 | geslacht                                | 2     | 1            |
  ...
  Rule: Afhankelijk van de in inOnderzoek opgenomen velden wordt datumIngangOnderzoek, datumIngangOnderzoekPersoon, datumIngangOnderzoekGemeente en/of datumIngangOnderzoekGezag opgenomen
    - datumIngangOnderzoekPersoon bij de velden burgerservicenummer, geslacht en leeftijd van de opgevraagde persoon
    - datumIngangOnderzoekGemeente bij de velden gemeenteVanInschrijving en/of datumInschrijvingInGemeente
    - datumIngangOnderzoekGezag bij de velden indicatieCurateleRegister en/of indicatieGezagMinderjarige
    - in alle andere gevallen datumIngangOnderzoek

    Scenario: persoon heeft gezagInOnderzoek, gemeenteInOnderzoek en persoonInOnderzoek
      Gegeven de persoon met burgerservicenummer '000000139' heeft de volgende gegevens
      | geslachtsaanduiding (04.10) | aanduiding in onderzoek (83.10) | datum ingang onderzoek (83.20) | 
      | V                           | 010410                          | 20120920                       |
      En de persoon heeft de volgende 'gezagsverhouding' gegevens
      ...
      | 1                                  | 113310                         | 20101205                       |
	  En de persoon heeft de volgende 'verblijfplaats' gegevens
      | datum inschrijving in de gemeente (09.20) | aanduiding in onderzoek (83.10) | datum ingang onderzoek (83.20) | 
      | 20020202                                  | 080920                          | 20120928                       |
      Als personen wordt gezocht met de volgende parameters
      | naam                | waarde                                                         |
      | type                | RaadpleegMetBurgerservicenummer                                |
      | burgerservicenummer | 000000139                                                      |
      | fields              | geslacht,indicatieCurateleRegister,datumInschrijvingInGemeente |
      Dan heeft de response een persoon met de volgende gegevens
      | naam                                                 | waarde            |
	  | geslacht.code                                        | V                 |
	  | geslacht.omschrijving                                | Vrouw             |
	  ...
	  | datumInschrijvingInGemeente.datum                    | 2002-02-02        |
	  | datumInschrijvingInGemeente.langFormaat              | 2 februari 2002   |
      | inOnderzoek.geslacht                                 | true              |
      | inOnderzoek.datumIngangOnderzoekPersoon.type         | Datum             |
      ...
      | inOnderzoek.datumIngangOnderzoekGemeente.type        | Datum             |
      | inOnderzoek.datumIngangOnderzoekGemeente.datum       | 2012-09-29        |
      | inOnderzoek.datumIngangOnderzoekGemeente.langFormaat | 29 september 2012 |
...
# Om onderscheid te maken tussen de situatie dat een gegeven niet in de resource voorkomt omdat het geen waarde heeft of omdat het geen 
# onderdeel uitmaakt van de resource heb ik de formulering van de 1e bullet gewijzigd.
  Rule: in onderzoek wordt niet opgenomen wanneer het gegeven of de groep dat onderzocht wordt niet wordt gevraagd
    Dit is het geval wanneer gegevens in onderzoek zijn die:
    - geen onderdeel uitmaken van de resource
    - niet gevraagd zijn met fields

    Scenario: persoon heeft hele categorie persoon in onderzoek maar niet vragen om gegevens uit categorie persoon
    ...
    Scenario: persoon heeft hele categorie kinderen in onderzoek maar niet vragen om gegevens uit categorie kinderen
      ...
      | geboortedatum (03.10)           | 19231213 |
      | aanduiding in onderzoek (83.10) | 020000   | 
      | datum ingang onderzoek (83.20)  | 20220307 |
      Als personen wordt gezocht met de volgende parameters
      | naam                | waarde                          |
      | type                | RaadpleegMetBurgerservicenummer |
    ...
    Scenario: persoon heeft EU-persoonsnummer van nationaliteit in onderzoek die geen onderdeel uitmaakt van de resource
  ...
  Rule: een afgeleid gegeven wordt in inOnderzoek opgenomen wanneer ten minste één van de gegevens waaruit het wordt afgeleid in onderzoek staat
    ...
    Abstract Scenario: verblijfplaats adresregel1, adresregel2 en woonplaats in onderzoek bij <gegeven in onderzoek> is in onderzoek
      ...
      Voorbeelden:
      | gegeven in onderzoek      | waarde | type                   | adresregel1 | adresregel2 | korteNaam | straat | woonplaats | verbl.plaats type | verbl.plaats datum | verbl.plaats datumtype | verbl.plaats lang | verbl.adres datum | verbl.adres datumtype | verbl.adres lang |
      ...
      | groep adres               | 081100 | VerblijfplaatsOnbekend | true        | true        | true      | true   | true       | true              | 2022-03-07         | Datum                  | 7 maart 2022      | 2022-03-07        | Datum                 | 7 maart 2022     | 
  ...
  Rule: Als 'inOnderzoek' of een of meer velden van ‘inOnderzoek’ m.b.v. 'fields' worden bevraagd dan worden deze niet teruggeleverd. 
    ...
    Abstract Scenario: Bevraag <omschrijving> en een veld buiten inOnderzoek dat <type> is
      ...
      | naam                                                | waarde                 |
      | burgerservicenummer                                 | 000000590              |
	  | geslacht.code                                       | <geslachtcode>         |
	  | geslacht.omschrijving                               | <geslachtomschrijving> |
	  | inOnderzoek.datumIngangOnderzoekPersoon.datum       | <datum>                |
	  | inOnderzoek.datumIngangOnderzoekPersoon.type        | <datumtype>            |
	  | inOnderzoek.datumIngangOnderzoekPersoon.langFormaat | <langFormaat>          |
