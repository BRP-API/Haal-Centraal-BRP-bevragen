...
Functionaliteit: Als gemeente wil ik de juiste en consistente aanschrijfwijze van mijn burgers
  ...
  Op basis van attribuut adellijkeTitel_predikaat wordt het de adelijke titel of het predikaat toegevoegd in de aanschrijfwijze. Zie ook de tabel "Voorbeelden: adelijke titels en predikaat" hieronder.
    ...
    Als de betrokkene over een adelijke titel beschikt, Dan wordt de adelijke titel geplaatst tussen voorletters en achternaam (voorvoegsel en geslachtsnaam).
    Als de betrokkene beschikt over een predikaat of adelijke titel, Dan wordt deze opgenomen zoals genoemd in kolom "Omschrijving" in GBA tabel 38 "Adellijke titel/predikaat", geschreven in kleine letters.
    ...
    Als betrokkene de achternaam van de echtgenoot/partnergebruikt, Dan wordt de eigen adellijke titel of predikaat niet gebruikt.
    Als de betrokkene beschikt over een predikaat En betrokkene gebruikt de achternaam van de echtgenoot/partner, Dan wordt het predikaat niet gebruikt.
    Als de echtgenoot/partner beschikt over een predikaat, Dan wordt bij gebruik van de achternaam van de echtgenoot/partner het predikaat van de echtgenoot/partner niet meegenomen.
  ...
  Wanneer er meerdere ontbonden huwelijken/partnerschappen zijn en er geen actueel (niet ontbonden) huwelijk/partnerschap is en de aanschijfwijze is ongelijk aan 'Eigen', wordt als partnernaam de naam van de laatst ontbonden relatie gebruikt.
  ...
  Abstract Scenario: De aanschrijfwijze wordt samengesteld op basis van aanduidingAanschrijving en naamgegevens van de persoon en de partner
    ...
    Voorbeelden: betrokkene heeft een adelijke titel en partner heeft geen adellijke titel noch predikaat
      | aanduidingAanschrijving | samenstelling aanschrijfwijze | geslachtsnaam | voornamen | aanschrijfwijze |
    ...
    Voorbeelden: betrokkene heeft een predikaat en partner heeft geen adellijke titel noch predikaat
      | aanduidingAanschrijving | samenstelling aanschrijfwijze | geslachtsnaam | voornamen | aanschrijfwijze |
      | E | PK VL VV GN       | Hoogh | Tim            | jonkheer T. van Hoogh |
      | N | VL VV GN-VP GP    | Hoogh | Charlotte      | C. van Hoogh-van der Berg |
      | P | VL VP GP          | Hoogh | Belle          | B. van der Berg |
      | V | VL VP GP-VV GN    | Hoogh | Erik           | E. van der Berg-van Hoogh |

    Voorbeelden: betrokkene heeft geen predikaat noch adellijke titel en partner heeft een adellijke titel
    ...
    Voorbeelden: betrokkene heeft geen predikaat noch adellijke titel en partner heeft een predikaat
      | aanduidingAanschrijving | samenstelling aanschrijfwijze | geslachtsnaam | voornamen | aanschrijfwijze |
