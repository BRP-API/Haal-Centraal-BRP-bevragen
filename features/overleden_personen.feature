...
Functionaliteit: Een zoekvraag levert alleen personen op die nog in leven zijn
  ...
  Achtergrond:
    ...
    En er is ten minste één andere persoon met geslachtsnaam "Groenen" en geboortedatum "1983-05-26" die niet overleden is
    En er is ten minste één andere persoon met postcode "2595AK" en huisnummer 21 die niet overleden is
    En er is ten minste één andere persoon met nummeraanduidingIdentificatie "689047857696734" die niet overleden is
  ...
  Scenario: Met parameter inclusiefoverledenpersonen=true worden ook overleden personen gezocht
    ...
    En wordt de persoon gevonden zonder veld overlijden
    Als personen gezocht worden met ?verblijfplaats__postcode=2595AK&verblijfplaats__huisnummer=21&inclusiefoverledenpersonen=true
    Dan wordt de persoon gevonden met overlijden.datum.datum=2018-01-23
    En wordt de persoon gevonden veld overlijden
    Als personen gezocht worden met ?veblijfplaats__nummeraanduidingIdentificatie=689047857696734&inclusiefoverledenpersonen=true
    Dan wordt de persoon gevonden met overlijden.datum.datum=2018-01-23
    En wordt de persoon gevonden veld overlijden
