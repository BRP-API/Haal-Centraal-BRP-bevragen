...
Functionaliteit: Automatisch laden van sub-resources
  ...
  Relaties (links) van de embedded resource kunnen worden gevraagd met de naam van de relatie. Bijvoorbeeld expand=partners.ingeschrevenpersonen geeft de link (uri) van de resource die de partner is van de bevraagde persoon. Hiermee wordt dus niet deze relatie van de relatie embed.
