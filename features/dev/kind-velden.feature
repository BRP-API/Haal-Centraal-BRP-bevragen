...
Functionaliteit: Kind
  ...
  Abstract Scenario: kind heeft '<gegevensgroep>' veld: '<gba naam>'
    ...
    | naam          | voornamen (02.10)                    | voornamen                            | Piet       | Piet                         |
    | naam          | voorvoegsel (02.30)                  | voorvoegsel                          | in den     | in den                       |
    | naam          | geslachtsnaam (02.40)                | geslachtsnaam                        | Jansen     | Jansen                       |
    | naam          | adellijke titel of predicaat (02.20) | adellijkeTitelPredicaat.code         | JH         | JH                           |
    | naam          | adellijke titel of predicaat (02.20) | adellijkeTitelPredicaat.omschrijving | JH         | Jonkheer                     |
