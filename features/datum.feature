...
Functionaliteit: leveren van een datum
  ...
  Rule: een datum krijgt type "DatumOnbekend" wanneer de GBA datum gelijk is aan "00000000".
    ...
    Gegeven de persoon met burgerservicenummer '000000243' heeft een <relatie> met de volgende gegevens
      ...
      | ouder '1' | ouder      | ouders      | inOnderzoek          | datumIngangOnderzoek | Datum          | 020000                 | 20200308 | 2020-03-08 |      |       |          | 8 maart 2020 |
      | ouder '1' | ouder      | ouders      | inOnderzoek          | datumIngangOnderzoek | DatumOnbekend  | 020000                 | 00000000 |            |      |       | true     | onbekend     |
      | ouder '1' | ouder      | ouders      | inOnderzoek          | datumIngangOnderzoek | JaarDatum      | 020000                 | 20200000 |            | 2020 |       |          | 2020         |
      | ouder '1' | ouder      | ouders      | inOnderzoek          | datumIngangOnderzoek | JaarMaandDatum | 020000                 | 20200300 |            | 2020 | 3     |          | maart 2020   |
