...
Functionaliteit: leveren van een datum
  ...
  Rule: een volledige datum wordt geleverd met een type op basis van de nauwkeurigheid van de waarde
    ...
    Abstract Scenario: <type> in <groep> <veld>
      ...
      | <veld>.leesbaarFormaat | <leesbaarFormaat |

      Voorbeelden:
      | groep                 | veld                                  | type           | GbaDatum | datum      | jaar | maand | onbekend | leesbaarFormaat
    ...
    Abstract Scenario: <type> in datumEersteInschrijvingGBA
      ...
      | datumEersteInschrijvingGBA.leesbaarFormaat | <leesbaarFormaat> |

      Voorbeelden:
      | type           | GbaDatum | datum      | jaar | maand | onbekend | leesbaarFormaat
    ...
    Abstract Scenario: <type> datumIngangFamilierechtelijkeBetrekking van ouders
      ...
      | datumIngangFamilierechtelijkeBetrekking.leesbaarFormaat | <leesbaarFormaat> |
     ...
     Abstract Scenario: <type> <groep> <veld> van <relatie>
      ...
      Voorbeelden:
      | relatie | field    | groep                       | veld                 | type           | GbaDatum | datum      | jaar | maand | onbekend | leesbaarFormaat
  ...
  Rule: verblijfplaats datumVan wordt gevuld uit datumAanvangAdreshouding of datumAanvangAdresBuitenland
    ...
    Abstract Scenario: <titel>
      ...
      | datumVan.leesbaarFormaat | <leesbaarFormaat> |

      Voorbeelden:
      | titel                                            | datumAanvangAdreshouding | datumAanvangAdresBuitenland | type           | datum      | jaar | maand | onbekend | leesbaarFormaat
