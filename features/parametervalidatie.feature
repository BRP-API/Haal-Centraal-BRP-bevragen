...
Functionaliteit: parameters worden gevalideerd
  ...
  * geslachtsaanduiding: parameterwaarde moet voorkomen in de waardetabel voor geslachtsaanduidingen die in de waardetabellen API wordt aangeboden
  ...
  Scenario: Zoeken met een parameterwaarde langer dan toegestaan levert een foutmelding
    Als personen gezocht worden met ?verblijfplaats__postcode=9744CZ&verblijfplaats__huisnummer=5&verblijfplaats__huisletter=AA
  ...
  Scenario: Zoeken met een parameterwaarde die niet voldoet aan het gedefinieerde patroon levert een foutmelding
    Als personen gezocht worden met ?verblijfplaats__postcode=XX44CZ&verblijfplaats__huisnummer=5
    Dan levert dit een foutmelding
  ...
  Scenario: Zoeken met een parameterwaarde op een integer die geen geldig geheel getal is levert een foutmelding
    ...
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter verblijfplaats__huisnummer
    Als personen gezocht worden met ?verblijfplaats__postcode=9744CZ&verblijfplaats__huisnummer=1.2
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter verblijfplaats__huisnummer
    Als personen gezocht worden met ?verblijfplaats__postcode=9744CZ&verblijfplaats__huisnummer=1,2
    Dan levert dit een foutmelding
  ...
  Scenario: Zoeken met een parameterwaarde die niet voorkomt in de gedefinieerde enumeratielijst levert een foutmelding
    Als personen gezocht worden met ?naam__geslachtsnaam=groen&geboorte__datum=1983-05-26&geslachtsaanduiding=Y
    Dan levert dit een foutmelding
  ...
  Scenario: Zoeken met een parameterwaarde die geen true of false is op een boolean parameter levert een foutmelding
    Als personen gezocht worden met ?naam__geslachtsnaam=groen&geboorte__datum=1983-05-26&inclusiefoverledenpersonen=true
    Dan levert dit zoekresultaten
    Als personen gezocht worden met ?naam__geslachtsnaam=groen&geboorte__datum=1983-05-26&inclusiefoverledenpersonen=false
    Dan levert dit zoekresultaten
    Als personen gezocht worden met ?naam__geslachtsnaam=groen&geboorte__datum=1983-05-26&inclusiefoverledenpersonen=True
    Dan levert dit zoekresultaten
    Als personen gezocht worden met ?naam__geslachtsnaam=groen&geboorte__datum=1983-05-26&inclusiefoverledenpersonen=ja
    Dan levert dit een foutmelding
  ...
  Scenario: Zoeken met onvolledige geboortedatum wordt niet ondersteund
    Als personen gezocht worden met ?naam__geslachtsnaam=groen*&geboorte__datum=1983-05-00
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter geboorte__datum
    Als personen gezocht worden met ?naam__geslachtsnaam=groen*&geboorte__datum=1983-05
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter geboorte__datum
    Als personen gezocht worden met ?naam__geslachtsnaam=groen*&geboorte__datum=1983
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter geboorte__datum

  Scenario: Bij zoeken op een datum-parameter moet de parameterwaarde datum in het ISO 8601 formaat jjjj-mm-dd zijn
    Als personen gezocht worden met ?naam__geslachtsnaam=groen*&geboorte__datum=1983-05-AA
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter geboorte__datum
    Als personen gezocht worden met ?naam__geslachtsnaam=groen*&geboorte__datum=19830526
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter geboorte__datum
    Als personen gezocht worden met ?naam__geslachtsnaam=groen*&geboorte__datum=26-05-1983
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter geboorte__datum

  Scenario: Bij zoeken op een datum-parameter moet de parameterwaarde een geldige datum zijn
    Als personen gezocht worden met ?naam__geslachtsnaam=groen*&geboorte__datum=1983-05-32
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter geboorte__datum
    Als personen gezocht worden met ?naam__geslachtsnaam=groen*&geboorte__datum=1983-02-30
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter geboorte__datum
    Als personen gezocht worden met ?naam__geslachtsnaam=groen*&geboorte__datum=1983-13-01
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter geboorte__datum

  Scenario: Bij zoeken op gemeente van inschrijving moet een gemeentecode worden gebruikt die bestaat
    Als personen gezocht worden met ?verblijfplaats__naamopenbareruimte=Sint%20Aldegondestraat&verblijfplaats__huisnummer=2&verblijfplaats__gemeentevaninschrijving=0503
    Dan levert dit zoekresultaten
    Als personen gezocht worden met ?verblijfplaats__naamopenbareruimte=Sint%20Aldegondestraat&verblijfplaats__huisnummer=2&verblijfplaats__gemeentevaninschrijving=503
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter verblijfplaats__gemeentevaninschrijving
    Als personen gezocht worden met ?verblijfplaats__naamopenbareruimte=Sint%20Aldegondestraat&verblijfplaats__huisnummer=2&verblijfplaats__gemeentevaninschrijving=ABCD
    Dan levert dit een foutmelding
    En heeft de foutmelding betrekking op parameter verblijfplaats__gemeentevaninschrijving
