...
Functionaliteit: autorisatie verblijfplaatsgegevens Persoon
  ...
  Rule: Wanneer met fields gevraagd wordt om een veld waarvoor de gebruiker niet geautoriseerd is, wordt een foutmelding gegeven
    ...
    Abstract Scenario: Afnemer vraagt <gevraagd veld>, en heeft uitsluitend de autorisatie die nodig is om deze vraag te mogen stellen
      ...
      | verblijfplaats.verblijfplaats.datumVan                            | 81110 81210 81310 PAVP01                                                                                     |
      | verblijfplaats.verblijfplaats.datumVan.type                       | 81110 81210 81310 PAVP01                                                                                     |
      | verblijfplaats.verblijfplaats.datumVan.datum                      | 81110 81210 81310 PAVP01                                                                                     |
      | verblijfplaats.verblijfplaats.datumVan.langFormaat                | 81110 81210 81310 PAVP01                                                                                     |
      | verblijfplaats.verblijfplaats.datumVan.jaar                       | 81110 81210 81310 PAVP01                                                                                     |
      | verblijfplaats.verblijfplaats.datumVan.maand                      | 81110 81210 81310 PAVP01                                                                                     |
      | verblijfplaats.verblijfplaats.datumVan.onbekend                   | 81110 81210 81310 PAVP01                                                                                     |
  ...
  Rule: Een gemeente als afnemer is geautoriseerd voor alle verblijfplaats gegevens
    ...
    Abstract Scenario: Gemeente vraagt om velden in verblijfplaats en er zit geen enkel verblijfplaatsgegeven in de autorisatie
      ...
      | verblijfplaats.verblijfadres.adresregel1     |
  ...
  Rule: Wanneer met fields een veld van verblijfplaats wordt gevraagd en de afnemer is niet geautoriseerd voor een van de velden waarmee type verblijfplaats wordt bepaald, wordt een foutmelding gegeven
    ...
    Abstract Scenario: Afnemer is wel geautoriseerd voor gevraagde veld, maar niet voor <missende autorisatie> die nodig is voor verblijfplaats type
      ...
      | verblijfadres.huisnummertoevoeging.code         | 81140 81210 81310  | straat (81110)              |
      | verblijfadres.huisnummertoevoeging.omschrijving | 81140 81210 81310  | straat (81110)              |
      ...
      | verblijfadres.huisnummertoevoeging.code         | 81140 81110 81310  | locatiebeschrijving (81210) |
      | verblijfadres.huisnummertoevoeging.omschrijving | 81140 81110 81310  | locatiebeschrijving (81210) |
      ...
      | verblijfadres.huisnummertoevoeging.code         | 81140 81110 81210  | land (81310)                |
      | verblijfadres.huisnummertoevoeging.omschrijving | 81140 81110 81210  | land (81310)                |
  ...
  Rule: de 'verblijfplaatsBinnenland' field alias moet worden gebruikt door een consumer die niet is geautoriseerd voor het bevragen van 'verblijfplaats buitenland' velden
    ...
    Abstract Scenario: Afnemer vraagt om alleen binnengemeentelijke verblijfplaatsgegevens, en heeft uitsluitend de autorisatie die nodig is om deze vraag te mogen stellen
      ...
      | verblijfplaatsBinnenland.verblijfplaats.datumVan                            | 81110 81210 PAVP01                                                                    |
      | verblijfplaatsBinnenland.verblijfplaats.datumVan.type                       | 81110 81210 PAVP01                                                                    |
      | verblijfplaatsBinnenland.verblijfplaats.datumVan.datum                      | 81110 81210 PAVP01                                                                    |
      | verblijfplaatsBinnenland.verblijfplaats.datumVan.langFormaat                | 81110 81210 PAVP01                                                                    |
      | verblijfplaatsBinnenland.verblijfplaats.datumVan.jaar                       | 81110 81210 PAVP01                                                                    |
      | verblijfplaatsBinnenland.verblijfplaats.datumVan.maand                      | 81110 81210 PAVP01                                                                    |
      | verblijfplaatsBinnenland.verblijfplaats.datumVan.onbekend                   | 81110 81210 PAVP01                                                                    |
