...
Functionaliteit: inOnderzoek booleans van adres binnenland vullen
  ...
  Rule: Als aanduiding in onderzoek (83.10) een waarde heeft wordt deze waarde vertaald naar de corresponderde ïnOnderzoek" Booleans. 
     ...
     Abstract Scenario: verblijfadres binnenland veld(en) van persoon is/zijn in onderzoek
    ...
    Abstract Scenario: 'huisletter (11.30)' is in onderzoek
      ...
      Voorbeelden:  Abstract Scenario: 'aanduiding bij huisnummer (11.50)' is in onderzoek
      | gba in onderzoek waarde |
      | 080000                  |
      | 081100                  |
      | 081130                  |
