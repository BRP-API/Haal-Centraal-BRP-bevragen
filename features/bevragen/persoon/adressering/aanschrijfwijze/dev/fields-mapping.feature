...
Functionaliteit: Fields vertalen van proxy naar gba voor aanschrijfwijze
  ...
  Rule: Voor sommige gevraagde velden in fields moeten (aanvullend) andere velden worden geleverd
    ...
    Scenario: aanschrijfwijze.aanspreekvorm is gevraagd voor persoon met ex-partner
      Gegeven de persoon met burgerservicenummer '000000139' heeft de volgende gegevens
      | naam                                 | waarde    |
      | geslachtsaanduiding (04.10)          | M         |
      | voornamen (02.10)                    | Jan Peter |
    ...
    Scenario: aanschrijfwijze.aanspreekvorm is gevraagd voor persoon met actuele partner
      Gegeven de persoon met burgerservicenummer '000000139' heeft de volgende gegevens
      | naam                                 | waarde    |
      | geslachtsaanduiding (04.10)          | M         |
      | voornamen (02.10)                    | Jan Peter |
      ...
      | voorvoegsel (02.30)                                                | van den        |
      | geslachtsnaam (02.40)                                              | Aedel          |
      | datum huwelijkssluiting/aangaan geregistreerd partnerschap (06.10) | 20211109       |
      Als gba personen wordt gezocht met de volgende parameters
      | naam                | waarde                                    |
      | type                | RaadpleegMetBurgerservicenummer           |
      | burgerservicenummer | 000000139                                 |
