...
Functionaliteit: autorisatie voor gebruikInLopendeTekst
  ...
  Rule: Vragen met fields om gebruikInLopendeTekst, wanneer de gebruiker niet geautoriseerd is voor alle velden waaruit gebruikInLopendeTekst wordt afgeleid, geeft een foutmelding
    ...
    Scenario: Afnemer vraagt om gebruikInLopendeTekst en heeft de daarvoor minimale autorisatie
    ...
    @fout-case
    Scenario: Afnemer vraagt om gebruikInLopendeTekst en is niet geautoriseerd voor <missende autorisatie>
      Gegeven de afnemer met indicatie '000008' heeft de volgende 'autorisatie' gegevens
      | Rubrieknummer ad hoc (35.95.60) | Medium ad hoc (35.95.67) | Datum ingang (35.99.98) |
      ...
      | status   | 403                                                                     |
      | detail   | De foutieve fields waarden zijn: adressering.gebruikInLopendeTekst.     |
      | code     | authorization                                                           |
