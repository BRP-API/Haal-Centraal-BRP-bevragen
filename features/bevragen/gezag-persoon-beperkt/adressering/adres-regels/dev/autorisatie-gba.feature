...
@gba @autorisatie
Functionaliteit: autorisatie adressering adresregels GezagPersoonBeperkt
  ...
  Rule: Vragen met fields om een adresregel, wanneer de gebruiker niet geautoriseerd is voor alle velden waaruit betreffende adresregel wordt afgeleid, geeft een foutmelding
    ...
    Scenario: Afnemer vraagt om adressering.adresregel1 en heeft uitsluitend de autorisatie die nodig is om deze vraag te mogen stellen
      ...
      | 81110 81120 81130 81140 81150 81180 81210 81310 81330 | N                        | 20201128                |
    ...
    Abstract Scenario: Afnemer vraagt om adressering.adresregel1 en is niet geautoriseerd voor <missende autorisatie>
      ...
      | 81120 81130 81140 81150 81180 81210 81310 81330 | korteStraatnaam (81110)         |
      | 81110 81130 81140 81150 81180 81210 81310 81330 | huisnummer (81120)              |
      | 81110 81120 81140 81150 81180 81210 81310 81330 | huisletter (81130)              |
      | 81110 81120 81130 81150 81180 81210 81310 81330 | huisnummertoevoeging (81140)    |
      | 81110 81120 81130 81140 81180 81210 81310 81330 | aanduidingBijHuisnummer (81150) |
      | 81110 81120 81130 81140 81180 81150 81310 81330 | locatiebeschrijving (81210)     |
      | 81110 81120 81130 81140 81180 81150 81210 81330 | land (81310)                    |
      | 81110 81120 81130 81140 81180 81150 81210 81310 | regel1 (81330)                  |
    ...
    Scenario: Afnemer vraagt om adresseringBinnenland.adresregel1 en heeft uitsluitend de autorisatie die nodig is om deze vraag te mogen stellen
      Gegeven de afnemer met indicatie '000008' heeft de volgende 'autorisatie' gegevens
      | Rubrieknummer ad hoc (35.95.60)           | Medium ad hoc (35.95.67) | Datum ingang (35.99.98) |
      | 81110 81120 81130 81140 81150 81180 81210 | N                        | 20201128                |
      En de geauthenticeerde consumer heeft de volgende 'claim' gegevens
      | naam         | waarde |
      | afnemerID    | 000008 |
      | gemeenteCode | 0518   |
    ...
    Scenario: Afnemer vraagt om adressering.adresregel2 en heeft uitsluitend de autorisatie die nodig is om deze vraag te mogen stellen
      Gegeven de afnemer met indicatie '000008' heeft de volgende 'autorisatie' gegevens
      | Rubrieknummer ad hoc (35.95.60)                       | Medium ad hoc (35.95.67) | Datum ingang (35.99.98) |
      | 80910 81110 81120 81160 81170 81180 81210 81310 81340 | N                        | 20201128                |
      En de geauthenticeerde consumer heeft de volgende 'claim' gegevens
      | naam         | waarde |
      | afnemerID    | 000008 |
      | gemeenteCode | 0518   |
    ...
    Abstract Scenario: Afnemer vraagt om adressering.adresregel2 en is niet geautoriseerd voor <missende autorisatie>
      ...
      Voorbeelden:
      | ad hoc rubrieken                                | missende autorisatie            |
      | 81110 81120 81160 81170 81180 81210 81310 81340 | gemeenteVanInschrijving (80910) |
      | 80910 81120 81160 81170 81180 81210 81310 81340 | korteStraatnaam (81110)         |
      | 80910 81110 81160 81170 81180 81210 81310 81340 | huisnummer (81120)              |
      | 80910 81110 81120 81170 81180 81210 81310 81340 | postcode (81160)                |
      | 80910 81110 81120 81160 81180 81210 81310 81340 | woonplaats (81170)              |
      | 80910 81110 81120 81160 81170 81180 81310 81340 | locatiebeschrijving (81210)     |
      | 80910 81110 81120 81160 81170 81180 81210 81340 | land (81310)                    |
      | 80910 81110 81120 81160 81170 81180 81210 81310 | regel2 (81340)                  |
    ...
    Scenario: Afnemer vraagt om adresseringBinnenland.adresregel2 en heeft uitsluitend de autorisatie die nodig is om deze vraag te mogen stellen
      Gegeven de afnemer met indicatie '000008' heeft de volgende 'autorisatie' gegevens
      | Rubrieknummer ad hoc (35.95.60)           | Medium ad hoc (35.95.67) | Datum ingang (35.99.98) |
      | 80910 81110 81120 81160 81170 81180 81210 | N                        | 20201128                |
      En de geauthenticeerde consumer heeft de volgende 'claim' gegevens
      | naam         | waarde |
      | afnemerID    | 000008 |
      | gemeenteCode | 0518   |
    ...
    Abstract Scenario: Afnemer vraagt om adressering.adresregel3 en is niet geautoriseerd voor <missende autorisatie>
      ...
      Voorbeelden:
      | ad hoc rubrieken | missende autorisatie |
      | 81180 81350      | land (81310)         |
      | 81180 81310      | regel3 (81350)       |
    ...
    Scenario: Afnemer vraagt om adressering.land en heeft uitsluitend de autorisatie die nodig is om deze vraag te mogen stellen
      Gegeven de afnemer met indicatie '000008' heeft de volgende 'autorisatie' gegevens
      | Rubrieknummer ad hoc (35.95.60) | Medium ad hoc (35.95.67) | Datum ingang (35.99.98) |
      | 81180 81310 81330 81340 81350   | N                        | 20201128                |
      En de geauthenticeerde consumer heeft de volgende 'claim' gegevens
      | naam         | waarde |
      | afnemerID    | 000008 |
      | gemeenteCode | 0518   |
    ...
    Abstract Scenario: Afnemer vraagt om adressering.land en is niet geautoriseerd voor verblijfplaats <missende autorisatie>
      ...
      Voorbeelden:
      | ad hoc rubrieken        | missende autorisatie |
      | 81180 81330 81340 81350 | land (81310)         |
      | 81180 81310 81340 81350 | regel1 (81330)       |
      | 81180 81310 81330 81350 | regel2 (81340)       |
      | 81180 81310 81330 81340 | regel3 (81350)       |
