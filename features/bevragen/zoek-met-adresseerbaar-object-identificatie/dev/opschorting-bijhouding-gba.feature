...
Functionaliteit: ZoekMetAdresseerbaarObjectIdentificatie van persoonslijst met opschorting bijhouding
  ...
  Rule: Een persoonslijst met reden opschorting bijhouding gelijk aan "O" (overleden) wordt niet geleverd

    Scenario: persoonslijst heeft opschorting bijhouding reden "O"
      Gegeven de persoon met burgerservicenummer '000000024' heeft de volgende 'verblijfplaats' gegevens
      | gemeente van inschrijving (09.10) |
      | 0599                              |
      En de 'verblijfplaats' heeft de volgende 'adres' gegevens
