...
Rule: de standaard adresregel (verkorte/volledige) field paden kan worden gebruikt door een consumer die is geautoriseerd voor het vragen van adresregels horende bij verblijfplaats buitenland
