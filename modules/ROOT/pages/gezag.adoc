...
. Wanneer minderjarige de vaste verblijfplaats in het buitenland heeft, is het gezag niet te bepalen. Lees de afleidingsregels voor link:/personen/features/gezag/niet-ingezetene[gezag bepalen voor minderjarigen die in het buitenland verblijven]
. Er wordt vastgesteld dat geen gezag is. Lees de afleidingsregels voor link:/personen/features/gezag/geen-gezag[geen gezag functionaliteit]
. Er is een gerechtelijke uitspraak over gezag, die kan worden herzien door adoptie, een reparatiehuwelijk of ontkenning. Lees de afleidingsregels voor link:/personen/features/gezag/gerechtelijke-uitspraak[gerechtelijke uitspraak]
. Gezag wordt bepaald van een minderjarige:
.. met twee ouders met een relatie met elkaar. Lees de afleidingsregels voor een link:/personen/features/gezag/twee-ouders-met-relatie[minderjarige met twee ouders met relatie]
.. met twee ouders zonder een relatie met elkaar. Lees de afleidingsregels voor een link:/personen/features/gezag/twee-ouders-geen-relatie[minderjarige met twee ouders zonder relatie]
.. met één ouder. Lees de afleidingsregels voor een link:/personen/features/gezag/een-ouder[minderjarige met één ouder]
.. zonder ouders. Lees de afleidingsregels voor een link:/personen/features/gezag/geen-ouder[minderjarige zonder ouder]
. Minderjarige heeft de de gewone verblijfplaats in het buitenland gehad. Lees de afleidingsregels voor link:/personen/features/gezag/immigrant[minderjarige die in het buitenland heeft verbleven]
. Gezaghouder(s) zijn niet bevoegd of overleden. Lees de afleidingsregels voor link:/personen/features/gezag/bevoegdheid-tot-gezag[bevoegdheid tot gezag].
