...
De API biedt naast persoonsgegevens uit de BRP ook informatieproducten zoals leeftijd, aanschrijfwijze, aanhef, een verwijzing naar een persoon in de tekst van een brief, of adressering (passend voor brief en vensterenvelop). Hiermee kan RvIG beter voorzien in klantbehoeften, en worden minder persoonsgegevens verstrekt. Hiervoor is een wetwijziging nodig: het [Experimentbesluit Dataminimalisatie](https://www.rijksoverheid.nl/documenten/besluiten/2023/08/28/experimentbesluit-brp-dataminimalisatie-amvb-nvt-versie-voorhang). 
