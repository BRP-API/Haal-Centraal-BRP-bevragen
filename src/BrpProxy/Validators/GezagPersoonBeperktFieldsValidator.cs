...
public class GezagPersoonBeperktFieldsValidator : AbstractValidator<string>
{
    ...
    public GezagPersoonBeperktFieldsValidator(FieldsHelper fieldsHelper)
    {
        var possibleFields = fieldsHelper.GezagPersoonBeperktFieldShortcuts;
        RuleFor(x => x)
