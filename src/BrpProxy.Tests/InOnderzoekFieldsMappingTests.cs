...
namespace BrpProxy.Tests
{
    public class InOnderzoekFieldsMappingTests
    {
        ...
        [InlineData("gezagsverhouding", "gezagsverhouding.inOnderzoek")]
        [InlineData("gezagsverhouding.indicatieCurateleRegister", "gezagsverhouding.inOnderzoek.indicatieCurateleRegister")]
