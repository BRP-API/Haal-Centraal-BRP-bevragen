...
class IngeschrevenPersonenApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_ingeschreven_personen = _Endpoint(
            settings={
        ...
        self.get_ingeschreven_persoon = _Endpoint(
            settings={
