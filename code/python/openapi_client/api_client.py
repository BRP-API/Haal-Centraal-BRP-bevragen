...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = IngeschrevenPersonenApi()
        api_instance.get_ingeschreven_personen  # this is an instance of the class Endpoint
        api_instance.get_ingeschreven_personen()  # this invokes api_instance.get_ingeschreven_personen.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_ingeschreven_personen.callable or self.callable in this class
