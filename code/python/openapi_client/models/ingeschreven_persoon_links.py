...
class IngeschrevenPersoonLinks(object):
    ...
    openapi_types = {
        ...
        'verblijfplaats_nummeraanduiding': 'HalLink'
    }
    ...
    attribute_map = {
        ...
        'verblijfplaats_nummeraanduiding': 'verblijfplaatsNummeraanduiding'
    }

    def __init__(self, _self=None, ouders=None, reisdocumenten=None, kinderen=None, partners=None, partnerhistorie=None, verblijfplaatshistorie=None, verblijfstitelhistorie=None, nationaliteit_historie=None, verblijfplaats_nummeraanduiding=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._verblijfplaats_nummeraanduiding = None
        ...
        if verblijfplaats_nummeraanduiding is not None:
            self.verblijfplaats_nummeraanduiding = verblijfplaats_nummeraanduiding
    ...
    def reisdocumenten(self):
        ...
        De ingezetene waaraan het REISDOCUMENT is verstrekt. Dit is de inverse relatie van heeftAlsHouder. Reisdocumenten die aan een ingezetene zijn verstrekt.  # noqa: E501
    ...
    @property
    def verblijfplaats_nummeraanduiding(self):
        """Gets the verblijfplaats_nummeraanduiding of this IngeschrevenPersoonLinks.  # noqa: E501


        :return: The verblijfplaats_nummeraanduiding of this IngeschrevenPersoonLinks.  # noqa: E501
        :rtype: HalLink
        """
        return self._verblijfplaats_nummeraanduiding

    @verblijfplaats_nummeraanduiding.setter
    def verblijfplaats_nummeraanduiding(self, verblijfplaats_nummeraanduiding):
        """Sets the verblijfplaats_nummeraanduiding of this IngeschrevenPersoonLinks.


        :param verblijfplaats_nummeraanduiding: The verblijfplaats_nummeraanduiding of this IngeschrevenPersoonLinks.  # noqa: E501
        :type: HalLink
        """

        self._verblijfplaats_nummeraanduiding = verblijfplaats_nummeraanduiding
