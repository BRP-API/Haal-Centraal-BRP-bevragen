...
class IndicatieGezagMinderjarigeEnum(object):
    ...
    allowable_values = [OUDER1, OUDER2, DERDEN, OUDER1_EN_DERDE, OUDER2_EN_DERDE, OUDER1_EN_OUDER2]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IndicatieGezagMinderjarigeEnum):
            return False
