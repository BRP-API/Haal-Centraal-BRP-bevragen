...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            Configuration.Default.BasePath = "https://virtserver.swaggerhub.com/VNGRealisatie/api/bevragingen_ingeschreven_personen";
            var apiInstance = new HistorieApi(Configuration.Default);
