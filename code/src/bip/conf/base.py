...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'bip'),
        'USER': os.getenv('DB_USER', 'bip'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'bip'),
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bip.utils.context_processors.settings',
            ],
...
DEFAULT_FROM_EMAIL = 'bip@example.com'
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    'handlers': {
        ...
        'project': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(LOGGING_DIR, 'bip.log'),
            'formatter': 'verbose',
            'maxBytes': 1024 * 1024 * 10,  # 10 MB
            'backupCount': 10
        },
...
AUTHENTICATION_BACKENDS = [
    'bip.accounts.backends.UserModelEmailBackend',
