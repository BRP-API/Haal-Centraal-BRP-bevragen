...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Ouder")]
    public partial class Ouder : IEquatable<Ouder>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Ouder);
        }

        /// <summary>
        /// Returns true if Ouder instances are equal
        /// </summary>
        /// <param name="input">Instance of Ouder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Ouder input)
        {
            if (input == null)
                return false;
