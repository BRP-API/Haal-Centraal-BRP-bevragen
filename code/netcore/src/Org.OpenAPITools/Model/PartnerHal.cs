...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PartnerHal :  IEquatable<PartnerHal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerHal" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PartnerHal);
        }

        /// <summary>
        /// Returns true if PartnerHal instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerHal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerHal input)
        {
            if (input == null)
                return false;
