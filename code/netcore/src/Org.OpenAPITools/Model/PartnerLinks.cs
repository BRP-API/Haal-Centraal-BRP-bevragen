...
namespace Org.OpenAPITools.Model
{
    ...
    /// PartnerLinks
    /// </summary>
    [DataContract(Name = "PartnerLinks")]
    public partial class PartnerLinks : IEquatable<PartnerLinks>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PartnerLinks);
        }

        /// <summary>
        /// Returns true if PartnerLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerLinks input)
        {
            if (input == null)
                return false;
