...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KindInOnderzoek :  IEquatable<KindInOnderzoek>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as KindInOnderzoek);
        }

        /// <summary>
        /// Returns true if KindInOnderzoek instances are equal
        /// </summary>
        /// <param name="input">Instance of KindInOnderzoek to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KindInOnderzoek input)
        {
            if (input == null)
                return false;
