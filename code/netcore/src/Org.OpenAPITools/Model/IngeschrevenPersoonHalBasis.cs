...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IngeschrevenPersoonHalBasis")]
    public partial class IngeschrevenPersoonHalBasis : IEquatable<IngeschrevenPersoonHalBasis>, IValidatableObject
    {
        ...
        /// <param name="aNummer">Het A-nummer van de persoon .</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ANummer: ").Append(ANummer).Append("\n");
        ...
        public bool Equals(IngeschrevenPersoonHalBasis input)
        {
            ...
            return 
                ...
                (
                    this.ANummer == input.ANummer ||
                    (this.ANummer != null &&
                    this.ANummer.Equals(input.ANummer))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ANummer != null)
                    hashCode = hashCode * 59 + this.ANummer.GetHashCode();
