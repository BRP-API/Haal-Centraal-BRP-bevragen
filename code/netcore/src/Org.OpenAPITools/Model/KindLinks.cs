...
namespace Org.OpenAPITools.Model
{
    ...
    /// KindLinks
    /// </summary>
    [DataContract(Name = "KindLinks")]
    public partial class KindLinks : IEquatable<KindLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KindLinks" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="ingeschrevenPersoon">ingeschrevenPersoon.</param>
        public KindLinks(HalLink self = default(HalLink), HalLink ingeschrevenPersoon = default(HalLink))
        {
            this.Self = self;
        ...
        {
            return this.Equals(input as KindLinks);
        }

        /// <summary>
        /// Returns true if KindLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of KindLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KindLinks input)
        {
            if (input == null)
                return false;
