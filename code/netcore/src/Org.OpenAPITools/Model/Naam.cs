...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Naam : IEquatable<Naam>, IValidatableObject
    {
        ...
        public Naam(string geslachtsnaam = default(string), string voorletters = default(string), string voornamen = default(string), string voorvoegsel = default(string), Waardetabel adellijkeTitelPredikaat = default(Waardetabel), NaamInOnderzoek inOnderzoek = default(NaamInOnderzoek))
        {
